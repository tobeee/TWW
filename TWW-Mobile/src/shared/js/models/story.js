(function() {
  ...
  var Story = Backbone.Model.extend({
    ...
    getGodUser: function() {
      return this.godUser || (this.godUser = new tww.m.User({id: this.get('creator_id')}));
    },

    getMap: function() {
      return this.map || (this.map = new tww.m.Map({story: this}));
    },

    getMessagesHistory: function() {
      return this.messagesHistory || (this.messagesHistory = new tww.m.MessagesHistory(undefined, {story: this}));
    },
    ...
    start: function(options) {
      ...
      this.fetchAssociations(['map', 'messages'], {
        success: function() {
          me.state = new tww.m.GameState(me);
