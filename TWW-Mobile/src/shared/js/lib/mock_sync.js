  ...
  window.MockSync = {
    ...
    data: {
      ...
      '/mobileendpointcharacter.js': [
        {
          attributes: {
            id: 1,
            user_id: 1,
            data: "{\"char_name\":\"Shire\",\"desc\":\"Some guy blah blah blah.\\n\\nHello World this is another paragraph.\\n\\nLorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas condimentum ligula a ante porttitor ut vulputate diam vestibulum. Quisque quis fermentum nunc. Curabitur non dui nisl.\\n\\nProin rhoncus, odio at hendrerit convallis, risus velit laoreet ante, eget consequat tortor nisl sed diam. Pellentesque sollicitudin sapien quis nunc pharetra vitae dignissim lectus semper. Sed varius sapien in purus pretium a iaculis quam congue.\"}",
      ...
      '/maps/$/storydata.js': function(id) {
        ...
        switch (id) {
          case 2:
            joinRequests.push(joinRequest(2));
            break;
          case 3:
            joinRequests.push(joinRequest(1));
            break;
        }
